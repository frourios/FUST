...
\lean{FUST.DζOperator.zeta6_sq, FUST.DζOperator.zeta6_mul_conj}
\leanok
\begin{align}
...
Since $\zeta_6 \notin \mathbb{R}$ while $\varphi^n \in \mathbb{R}$, the hyperbolic and elliptic sectors are trivially disjoint.
...
\[
\mathfrak{f} = \frac{\exp_{\mathsf{F}}(\varphi) - \exp_{\mathsf{F}}(\psi)}{\sqrt{5}} = \frac{\mathrm{Diff}_2[\exp_{\mathsf{F}}](1)}{\sqrt{5}}
\]

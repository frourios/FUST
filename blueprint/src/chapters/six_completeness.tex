...
\section{\texorpdfstring{$\mathrm{Diff}_6$}{Diff6} Spectral Coefficients}
\label{sec:spectral_coefficients}

\begin{definition}[Diff6 Spectral Coefficient]
\label{def:Diff6Coeff}
\lean{FUST.SpectralCoefficients.Diff6Coeff}
\leanok
\[
...
\label{thm:Diff6Coeff_fibonacci}
\lean{FUST.SpectralCoefficients.Diff6Coeff_fibonacci}
\leanok
$C_n = \sqrt{5} \cdot (F_{3n} - 3F_{2n} + F_n)$
\end{theorem}

\begin{theorem}[Polynomial Kernel Characterization]
\label{thm:Diff6Coeff_eq_zero_iff}
\lean{FUST.SpectralCoefficients.Diff6Coeff_eq_zero_iff}
\leanok
$C_n = 0 \iff n \le 2$. In particular, $C_0 = C_1 = C_2 = 0$ and $C_3 = 12\sqrt{5} \ne 0$.
\end{theorem}

\begin{theorem}[Factorization]
\label{thm:Diff6Coeff_factored}
\lean{FUST.SpectralCoefficients.Diff6Coeff_factored}
\leanok
\[
...
\label{thm:Diff6Coeff_asymptotic}
\lean{FUST.SpectralCoefficients.Diff6Coeff_asymptotic}
\leanok
...
\begin{definition}[Laurent Diff6 Coefficient]
\label{def:Diff6CoeffZ}
\lean{FUST.SpectralCoefficients.Diff6CoeffZ}
\leanok
...
\lean{FUST.SpectralCoefficients.Diff6_extended_kernel_dim}
\leanok
...
\lean{FUST.SpectralCoefficients.Diff6_kernel_gap_structure}
\leanok

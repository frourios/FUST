...
\leanok
\[
\dim(t_P) := (\dim(\mathrm{Diff}_6 f))^{-1} = (5, -1)
\]
\end{definition}
...
\leanok
\[
\mathrm{dimTimeD2} := (\dim(\mathrm{Diff}_2 f))^{-1} = (1, -1)
\]
...
\leanok
\[
\dim((\mathrm{Diff}_6 f)^2) = 2 \cdot (-5, 1) = (-10, 2)
\]
\end{definition}
...
$(\mathrm{Diff}_6 f)^2$ & $(-10, 2)$ & $F_\zeta^2$ & \texttt{dimLagrangian} \\

...
For the action functional $\mathcal{A}[f] = \int |D_6 f|^2 d\mu$, the integral variation gives:
\[
\delta\mathcal{A} = 2 \int D_6 f \cdot D_6(\delta f) \, d\mu = 2 \int \delta f \cdot D_6^\dagger(D_6 f) \, d\mu
\]

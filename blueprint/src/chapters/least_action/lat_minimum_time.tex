...
The structural minimum length has $\dim(l_{\mathrm{FUST}}) = (5, -1, 0)$: same $(p, \delta)$ but $\tau = 0$ (spatial). The numerical equality $t_{\mathrm{FUST}} = l_{\mathrm{FUST}} = 25/12$ reflects identical $(p, \delta)$ components; the $\tau$ distinction is preserved by the type system.

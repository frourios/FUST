...
\]
where $\mathrm{SY\_weight} = \dim\ker(D_6) = 3$ (spatial) and $\mathrm{AF\_weight} = 1$ (temporal).
...
$D_6$ minimum eigenvalue from gauge-invariant output at $d = 3$:
\[
...
\item $\checkmark$ \textbf{SU(3) mass gap}: $D_6$ minimum eigenvalue $\lambda_{\min} = 12/25 > 0$ from $C_3/(\sqrt{5})^5$.

...
FUST is a \textbf{theorem derived} from the ZF + DC axiom system. In particular, the Poincar\'{e} group $\mathrm{ISO}(3,1) = \mathrm{SO}(3,1) \ltimes \mathbb{R}^4$ is derived from $D_\zeta$ structure (Chapter~\ref{chap:mat_poincare}), and all physical laws follow:
\[
...
Kant & FUST \\
\hline
Spacetime is an a priori form of intuition & Spacetime $(3,1)$ derived from $D_\zeta$ via $\mathrm{ISO}(3,1)$ \\

...
\lean{FUST.TimeTheorem.abs_psi_lt_one}
\leanok
$|\psi| < 1$
\end{theorem}
...
\lean{FUST.TimeTheorem.phi_mul_abs_psi}
\leanok
$\varphi \cdot |\psi| = 1$
\end{theorem}
...
\lean{FUST.TimeTheorem.monomial_amplification}
\leanok
\[
...
\lean{FUST.TimeTheorem.phi_pow_gt_one}
\leanok
...
\item $|\psi| < 1$ (definition of past direction) --- \texttt{FUST.TimeTheorem.abs\_psi\_lt\_one}

...
The speed of light $c = l_{\mathrm{FUST}} / t_{\mathrm{FUST}}$ has dimension:
\[
...
\]
Lean: \texttt{FUST\_dim.Dim.dimLightSpeed}, \texttt{FUST\_dim.TimeTheorem.length\_eq\_speed\_times\_time}.

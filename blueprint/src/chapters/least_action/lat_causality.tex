...
\section{$F_\zeta$ as Causal Boundary (Light Cone) Identification}
...
\subsection{Correspondence with $F_\zeta$ Structure}
...
proper time $d\tau = 0$ & $N_6 f = 0$ \\
proper time $d\tau > 0$ & $N_6 f \neq 0$ \\
\hline
\end{tabular}
\end{center}

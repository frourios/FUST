...
\item \textbf{Mass Gap Theorem} (yangMills\_massGap): $\Delta = C_3/(\sqrt{5})^5 = 12/25 > 0$ for SU(3) via $D_6$; SU(2) mass gap via $D_5(x^2) \neq 0$; algebraic confinement from $\ker(D_6)$ not being a subalgebra
\end{enumerate}

...
\lean{FUST.LeastAction.D6_polynomial_deg2, FUST.LeastAction.kerD6_implies_perp_zero}
\leanok
For a state function $f : \mathbb{C} \to \mathbb{C}$, the following are equivalent:
\begin{enumerate}
...
$(2) \Rightarrow (1)$: Proven by \texttt{kerD6\_implies\_perp\_zero} and \texttt{perpD6\_zero\_implies\_ker}. If perpProjection is identically zero, then $f \in \ker(D_6)$.
\end{proof}
...
\lean{FUST.LeastAction.D6_gauge_scaling}
\leanok
...
\lean{FUST.LeastAction.kernel_interpolation_unique_D6}
\leanok

...
\begin{enumerate}
\item \textbf{Spacetime dimension}: $d = 4$ (from $I_4 = \mathrm{Fin}\,3 \oplus \mathrm{Fin}\,1$, $\dim\ker(D_6) + 1 = 3 + 1$)
...
\# & Condition & Status \\
\hline
1 & $\ker(D_6) = \mathrm{span}\{1, z, z^2\}$ (dim 3 = spatial DOF from $I_4$) & $\checkmark$ \\
...
\textbf{(viii) $\ker(D_6)$ invariance}: From \texttt{ker\_D6\_invariant\_timeEvolution}.
\end{proof}

...
\leanok
Spin count = 4. Allowed spins: $0, 1/2, 1, 2$.
...
\leanok
Fermion flavor count $= 3$ (from $|D_\zeta|^2 = 12(3a^2 + b^2)$).
\begin{align}
...
3 neutrino flavors from $3$ (SU(2) doublet with charged leptons).
...
\item Fermion flavor count = 3
\item Allowed spins = 4
...
Quantity & Value & Lean \\
\hline
Fermion flavors & $3$ & \texttt{fermionFlavorCount} \\
...
Allowed spins & $4$ & \texttt{allowedSpinCount} \\
\hline
\end{tabular}
\end{center}

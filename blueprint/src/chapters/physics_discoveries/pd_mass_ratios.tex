...
\leanok
\[
m_e = \Delta = \frac{C_3}{(\sqrt{5})^5} = \frac{12}{25} \quad [\mathrm{dimElectron} = (-5,1,-1)]
\]
...
$m_s/m_d = \varphi^6$ (ScaleQuantity, $\approx 17.94$) is structurally distinct from $\Delta = 12/25$ (ScaleQuantity at dimElectron $= (-5,1,-1)$, mass gap from $D_6$ gauge-invariant output).

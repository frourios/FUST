...
\[
z^2 \in \text{SY channel} \setminus \text{AF channel}: \quad N_6(z^2) = 0 \text{ but } N_5(z^2) \neq 0.
\]
...
\hline
Gluon (8) & $\Phi_S$ on SY channel & $N_6 = 0$ & massless \\
Photon & U(1) grading & All $N_m$ preserve & massless \\
$W^\pm$ & $\Phi_A$ on AF channel & $N_5(z^2) \neq 0$ & massive \\
